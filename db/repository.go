...
func Migrate(db *gorm.DB) {
	...
	db.AutoMigrate(&Pacient{})
	db.AutoMigrate(&Consults{})
	db.AutoMigrate(&Family{})
	db.AutoMigrate(&Brothers{})
	db.AutoMigrate(&BaseQuestions{})
	db.AutoMigrate(&MakeQuestions{})
	db.AutoMigrate(&AnsweredQuestion{})
}
